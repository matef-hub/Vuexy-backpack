@php
    ...
    // we add an asterisk for it. Case it's a subfield, that check is done upstream in repeatable_row.
    ...
    // Vuexy-friendly defaults while keeping Backpack's hooks intact
    $field['wrapper']['class'] = $field['wrapper']['class'] ?? 'form-group col-12 mb-4 vxy-field';
